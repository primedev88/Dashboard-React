...
import img from '../assets/iit-roorkee-logo.png'
...
const Content = () => {
  ...
  return (
    ...
    style={{ fill: '#ffffff', width: '289%', height: 202, }}
  >
    <path
  ...
  />
    ...
    <path d="M0 0v5.63C149.93 59 314.09 71.32 475.83 42.57c43-7.64 84.23-20.12 127.61-26.46 59-8.63 112.48 12.24 165.56 35.4C827.93 77.22 886 95.24 951.2 90c86.53-7 172.46-45.71 248.8-84.81V0z" />
      ...
      <div className="row header">
        <Card Icon={AiOutlineUsergroupAdd} title="Follwers" value="None :)"/>
        ...
        <svg className="bg-waves__"
    preserveAspectRatio="none"
    viewBox="0 0 1200 120"
    xmlns="http://www.w3.org/2000/svg"
    style={{ fill: '#ffffff', width: '289%', height: 202, transform: 'rotate(180deg)' }}
  >
    <path
    d="M0 0v46.29c47.79 22.2 103.59 32.17 158 28 70.36-5.37 136.33-33.31 206.8-37.5 73.84-4.36 147.54 16.88 218.2 35.26 69.27 18 138.3 24.88 209.4 13.08 36.15-6 69.85-17.84 104.45-29.34C989.49 25 1113-14.29 1200 52.47V0z"
    opacity=".25"
    ...
    <path d="M0 0v5.63C149.93 59 314.09 71.32 475.83 42.57c43-7.64 84.23-20.12 127.61-26.46 59-8.63 112.48 12.24 165.56 35.4C827.93 77.22 886 95.24 951.2 90c86.53-7 172.46-45.71 248.8-84.81V0z" />
        ...
        <div className="admin">
            ...
            <div className="info">
                ...
                <span className="admin-about">IIT Roorkee</span>
            </div>
        ...
        <section>
            ...
            <div className="summary">
                ...
                <span className="summary-info">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod sed possimus veritatis at molestiae obcaecati magnam quae tempore illo, alias ea? Explicabo, nesciunt soluta possimus animi similique atque inventore beatae nihil vitae!
                </span>
            </div>
      ...
      <div className="row side-rect">
        ...
        <div className="more-details">
            ...
            <span className="txt">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod nemo tempore voluptatibus quam repellendus inventore vel, possimus expedita sapiente animi laudantium voluptatum itaque. Consequatur eius magni eveniet rerum quae adipisci.</span>
        </div>
        </section>
      </div>
      <div className="row side-rect">
